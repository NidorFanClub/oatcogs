...
class Verification(commands.Cog):
    ...
    async def button(self, ctx):
        ...
        e.add_field(name=_("Joined Discord on"), value="June 15, 2016 11:32 AM\n(6 years ago")
        e.add_field(name=_("Joined this server on"), value="January 24, 2021 6:47 AM\n(a year ago)")
        e.set_footer(text=_("Member #1 | User ID: 192677766003556352"))
